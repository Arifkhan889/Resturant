                            ...
                            <li>
                                ...
                                <div class="hidden fixed top-0 px-6 py-4 sm:block">
                                  ...
                                  <li> <x-app-layout>
                                    ...
                                    @else
                                   <li> <a href="{{'login'}}" class="text-sm text-gray-700 underline">Login</a></li>
                                   @if (Route::has('register'))
                                 <li><a href="{{'register'}}" class="text-sm text-gray-700 underline">Register</a></li>
                                    @endif
                                    @endauth
                                   </div>
                                 @endif
